...
define config.name = _("My Template")

## A short name for the game used for executables and directories in the built
## distribution. This must be ASCII-only, and must not contain spaces, colons,
## or semicolons.

define build.name = "MyTemplate"
...
define config.save_directory = "MyTemplate-1770406638"
...
define config.sample_sound = "boom.mp3"
...
## Autosave. This will be disabled in order to avoid the bug where the continue 
## button appears after making a choice without saving the game. 
