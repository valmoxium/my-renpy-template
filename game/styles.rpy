...
define gui.text_font = gui.preference("font", default="fonts/StampatelloFaceto.otf")

# The text font for buttons
define gui.interface_text_font = gui.preference("interface_font", "fonts/Crimson-Text.ttf")
# The default size of in-game text
define gui.text_size = gui.preference("size", 24)
# The font for character names
define gui.name_text_font = gui.preference("name_font", "fonts/Crimson-Text.ttf")
...
default persistent.typeface = "Stampatello Faceto"

## The colors used for dialogue and menu choice text.
define gui.text_color = gui.preference("color", default ="#ffffff")
